...
const btcTransaction = async (from,to,privateKey)=>{
  let txid, vout = ""
   await axios.get(`https://blockstream.info/testnet/api/address/${from}/txs`).then((res)=>{
  ...
  tx.from(utxo).fee(20000)
    .to("mohjSavDdQYHRYXcS3uS6ttaHP8amyvX78", 5000)
  ...
  // push rawtransaction:
  await axios.post(`https://api.blockcypher.com/v1/bcy/test/txs/push?token=6319d95f7a834a24a0d441b3bb495906`,{"tx":txid}).then((res)=>{
